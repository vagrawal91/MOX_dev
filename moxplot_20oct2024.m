function [axs, lgds] = moxplot(P, D, Q, X, Y, datasetName, Pxlabels, Dxlabels, Qxlabels, Pylabel, Dylabel, Qylabel, plotAsSpectra, lambda)
...
%
    ...
    sc = 4;
    axis(sc*[-1 1 -1 1]);
    set(ax4, 'layer', 'top', 'box', 'on');
    xlabel('{\bfY}');
    ylabel('{\bfŶ}');
    lgd2 = legend(Qxlabels, 'location', 'southeast');
