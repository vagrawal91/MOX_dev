...
save('result_pulp_dataset.mat', 'MSEmox_rl_mean', 'MSEmox_ll_mean', 'MSEpls_mean', 'MSEcca_mean', 'MSEols_mean', 'MSEmox_rl_std', 'MSEmox_ll_std', 'MSEpls_std', 'MSEcca_std', 'MSEols_std', 'p', 'q', 'm', 'r', '-nocompression');
