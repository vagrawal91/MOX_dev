function [axs, lgds] = moxplot_1st(P, D, Q, X, Y, datasetName, Pxlabels, DQxlabels, Pylabel, DQylabel, plotAsSpectra, lambda)
...
%   Pylabel       - String for y-axis label of the predictor loadings plot (default: '\int {\bfP}d\lambda')
...
%
    ...
    if nargin < 9 || isempty(Pylabel)
        Pylabel = '\int {\bfP}d\lambda'; % Default Pylabel
    end
    ...
    if plotAsSpectra
        ...
        plot(lambda, (lambda(2)-lambda(1))*cumsum(P, 2), 'LineWidth', 2);
